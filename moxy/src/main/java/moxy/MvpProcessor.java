...
public class MvpProcessor {
     ...
     * <p>2) Checks if presenter with tag is already exist in {@link PresenterStore}, and returns
     * it</p>
     * <p>3) If {@link PresenterStore} doesn't contain MvpPresenter with current tag, {@link
     * PresenterField} will create it</p>
     *
     ...
     * @param delegateTag unique tag generated by {@link moxy.MvpDelegate#generateTag()}   @return
     * MvpPresenter instance
     */
    ...
    /**
     * <p>Gets presenters {@link java.util.List} annotated with {@link InjectPresenter} for
     * view.</p>
    ...
    <Delegated> List<MvpPresenter<? super Delegated>> getMvpPresenters(Delegated delegated,
        ...
        PresenterBinder<Delegated> presenterBinder =
            PresenterBinderLocator.getPresenterBinders(aClass);
        ...
        List<PresenterField<? super Delegated>> presenterFields =
            presenterBinder.getPresenterFields();

        for (PresenterField<? super Delegated> presenterField : presenterFields) {
            MvpPresenter<? super Delegated> presenter =
                (MvpPresenter<? super Delegated>) getMvpPresenter(delegated, presenterField,
                    delegateTag);
