...
public class MvpProcessor {
     ...
     * <p>2) Checks if presenter with tag is already exist in {@link PresenterStore}, and returns it</p> <p>3) If {@link PresenterStore} doesn't contain MvpPresenter with current tag, {@link PresenterField} will create it</p>
     *
    ...
    /**
     * <p>Gets presenters {@link java.util.List} annotated with {@link InjectPresenter} for view.</p> <p>See full info about getting presenter instance in {@link #getMvpPresenter}</p>
     *
