 ...
 * <li>Be careful if remove commands by another type. If you make it, be sure that inside your view method you fully
 * override view changes</li>
 * </ul>
 */
public interface StateStrategy {
     ...
     * {@link MvpView}
     *
     * @param currentState current state of {@link MvpViewState}. Each {@link ViewCommand} contains self parameters.
     * @param incomingCommand command for apply to {@link MvpView} This {@link ViewCommand} contains params of this
     * command.
