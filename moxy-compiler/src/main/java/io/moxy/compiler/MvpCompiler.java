...
import io.moxy.RegisterMoxyReflectorPackages;
import io.moxy.compiler.presenterbinder.InjectPresenterProcessor;
import io.moxy.compiler.presenterbinder.PresenterBinderClassGenerator;
import io.moxy.compiler.reflector.MoxyReflectorGenerator;
import io.moxy.compiler.viewstate.ViewInterfaceProcessor;
import io.moxy.compiler.viewstate.ViewStateClassGenerator;
import io.moxy.compiler.viewstateprovider.InjectViewStateProcessor;
import io.moxy.compiler.viewstateprovider.ViewStateProviderClassGenerator;
...
public class MvpCompiler extends AbstractProcessor {
    ...
    public static final String MOXY_REFLECTOR_DEFAULT_PACKAGE = "io.moxy";
